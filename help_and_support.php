...
<head>
    ...
    <title>Help and Support - TECH RIDE</title>
...
<body>
    ...
    <div class="container mt-5 pt-4">
        ...
        <p class="lead">If you have any questions or need assistance, please contact our support team.</p>
        
        <h2>Contact Us</h2>
        <p>You can reach us through the following methods:</p>
        <ul>
            <li>Email: support@techride.com</li>
            <li>Phone: 1-800-555-TECH</li>
        </ul>
        
        <h2>FAQs</h2>
        <p>Check our <a href="faq.php">FAQs</a> page for common questions and answers.</p>
    </div>
